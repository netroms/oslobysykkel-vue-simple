...
class StationApiProxyServiceTest {
  ...
  private static final String STATIONS_JSON = "{  \"stations\": [{\"id\": 157,\"in_service\": true,\"title\": \"Nylandsveien\","
  ...
  private static final String AVAIL_JSON = "{\"stations\": [{\"id\": 177,\"availability\": {\"bikes\": 0,\"locks\": 29,\"overflow_capacity\": false}}]}";
  private static final String AVAIL_JSON_BROKEN = "{\"sXXXtations\": [{\"id\": 177,\"availability\": {\"bikes\": 0,\"locks\": 29,\"overflow_capacity\": false}}]}";

  @Test
  void testStationParse() {
  ...
  @Test
  void testParseBrokenAvailabilityJson() {
    Config config = Config.create();
    StationApiProxyService stationApiProxyService = new StationApiProxyService(config);
    ...
    assertThrows(java.lang.NullPointerException.class, () ->
        stationApiProxyService.getStationsAsJsonValueStream(stations));
  }
}